...
<img src="https://gitee.com/sail-Yang/blogiamge/raw/master/img/20220316124953.png" title="" alt="" data-align="center">

&emsp;&emsp;可以看到Stu2是能访问同属于一个类的Stu1的私有成员。我们假如把`Func`这个函数定义在Student类外面，再去调用一下，结果如何呢？

![](https://gitee.com/sail-Yang/blogiamge/raw/master/img/20220316125417.png)
